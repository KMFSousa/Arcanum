...
public class StuffFactory {
    ...
    public Character newPlayer(List<Character> characterList, int x, int y) {
        ...
        Character player = new Character(gameSurface, characterBitmap1, x, y, true, 4, 4, 0.3f, 100, 10 );
    ...
    public Character newSlime(List<Character> characterList, int x, int y) {
        ...
        Character slime = new Character(gameSurface, slimeBitmap, x, y, false, 4, 5, 0.1f, 30, 1);
